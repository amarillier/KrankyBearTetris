...
echo "KrankyBear Tetris - Windows Sync, Compile. Package and Sync Back (bash)"
echo "================================================"
echo
...
# ./setIcon.sh Resources/Images/KrankyBearVikingHelmet.png bin/tetris-windows.exe
